...
class PILedClient(socket.socket):
    def __init__(self, *args, **kwargs):
        ...
        try:
            ...
            print("Unable to connect to host ip: {}, with port: {}.".format(self.host_ip,
                                                                            self.host_port))
    ...
    def sendread(self, message):
        try:
            ...
            print("Write/read operation has not succeded. Check that the device"
                  " at ip {}, port: {}, is still available."
                  " The current connection will be closed.".format(self.host_ip,
                                                                   self.host_port))
            self.close()
